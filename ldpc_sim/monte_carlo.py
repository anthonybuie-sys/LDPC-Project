...
class MonteCarloResult:
    ...
    def as_row(self, **extra: object) -> dict[str, object]:
        ...
        row: dict[str, object] = {
            ...
            "channel_quantizer_clip_count": self.saturation.channel,
            "app_init_saturation_count": self.saturation.app_init,
            "q_sub_saturation_count": self.saturation.q_sub,
            "min_input_clip_count": self.saturation.min_input_clip,
            "check_magnitude_clip_count": self.saturation.min_input_clip,
            "app_add_saturation_count": self.saturation.app_add,
            "app_update_saturation_count": self.saturation.app_add,
